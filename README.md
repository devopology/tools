...
**NOTE** : Scripts are provided in the project's scripts directory for the most normal and basic scenario (org.devopology.tools-toolset-1.0.0.jar in the current directory as the script. "Script" class defined in the root Java package with the source file located in the current directory as the script.
